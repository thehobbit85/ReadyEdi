...
$(function () {
 ...
 pathPrepare($bottom_chamber_line_bottom)
  ...
  //Animate svg paths
  var hardware_line_top_scene = new ScrollMagic.Scene({triggerElement: "#hardware_data", duration: "50%", tweenChanges: true})
  .setTween(tween_hardware_line_top)
  .addTo(controller)
  var hardware_line_bottom_scene = new ScrollMagic.Scene({triggerElement: "#hardware_data", duration: "50%", tweenChanges: true})
  .setTween(tween_hardware_line_bottom)
  .addTo(controller)
  var battery_chamber_line_top_scene = new ScrollMagic.Scene({triggerElement: "#battery_chamber_data", duration: "50%", tweenChanges: true})
  .setTween(tween_battery_chamber_line_top)
  .addTo(controller)
  var battery_chamber_line_bottom_scene = new ScrollMagic.Scene({triggerElement: "#battery_chamber_data", duration: "50%", tweenChanges: true})
  .setTween(tween_battery_chamber_line_bottom)
  .addTo(controller)
  var battery_line_top_scene = new ScrollMagic.Scene({triggerElement: "#battery_data", duration: "50%", tweenChanges: true})
  .setTween(tween_battery_line_top)
  .addTo(controller)
  var battery_line_bottom_scene = new ScrollMagic.Scene({triggerElement: "#battery_data", duration: "50%", tweenChanges: true})
  .setTween(tween_battery_line_bottom)
  .addTo(controller)
  var camera_mount_line_top_scene = new ScrollMagic.Scene({triggerElement: "#camera_mount_data", duration: "50%", tweenChanges: true})
  .setTween(tween_camera_mount_line_top)
  .addTo(controller)
  var camera_mount_line_bottom_scene = new ScrollMagic.Scene({triggerElement: "#camera_mount_data", duration: "50%", tweenChanges: true})
  .setTween(tween_camera_mount_line_bottom)
  .addTo(controller)
  var main_plate_line_top_scene = new ScrollMagic.Scene({triggerElement: "#main_plate_data", duration: "50%", tweenChanges: true})
  .setTween(tween_main_plate_line_top)
  .addTo(controller)
  var main_plate_line_bottom_scene = new ScrollMagic.Scene({triggerElement: "#main_plate_data", duration: "50%", tweenChanges: true})
  .setTween(tween_main_plate_line_bottom)
  .addTo(controller)
  var bottom_chamber_line_top_scene = new ScrollMagic.Scene({triggerElement: "#bottom_chamber_data", duration: "50%", tweenChanges: true})
  .setTween(tween_bottom_chamber_line_top)
  .addTo(controller)
  var bottom_chamber_line_bottom_scene = new ScrollMagic.Scene({triggerElement: "#bottom_chamber_data", duration: "50%", tweenChanges: true})
